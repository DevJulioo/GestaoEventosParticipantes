...
public class Eventos {
    ...
    public static final int LIMITE_MAXIMO_VAGAS = 100;
    private String nome;
    ...
    public void setVagas(int vagas) {
        ...
        if (vagas > LIMITE_MAXIMO_VAGAS) {
            throw new IllegalArgumentException("O número de vagas não pode exceder " + LIMITE_MAXIMO_VAGAS);
        }
        this.vagas = vagas;
    }
